    ...
    return (
        ...
        >
            ...
            <div className="anchorcontainer">
                <label htmlFor="model 1">Disease detecton model 1</label>
            <a href="http://localhost:8501" target="_blank" class="anchor" id="model 1">click me</a>
            <label htmlFor="model 2">Disease detecton model 2</label>
            <a href="http://127.0.0.1:5000" target="_blank" class="anchor" id="model 2">click me</a>
            </div>
            <div>
                <h1>Latest Image</h1>
                <Showimage />
